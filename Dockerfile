...
FROM ubuntu
ADD http://downloads.nativedocuments.com/NativeDocumentsServices-2.0-2.initd.x86_64.deb /tmp/
RUN dpkg -i /tmp/NativeDocumentsServices-2.0-2.initd.x86_64.deb && rm /tmp/NativeDocumentsServices-2.0-2.initd.x86_64.deb
